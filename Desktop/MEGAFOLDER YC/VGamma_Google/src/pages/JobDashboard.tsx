...
Title: ${jobData.title}
Date Created: ${jobData.dateCreated}

SELECTED AGENT
--------------
Agent ID: ${jobData.selectedAgent.id}
Bid Price: ${jobData.selectedAgent.bidPrice.toFixed(2)} Locus

COST BREAKDOWN
--------------
Agent Fee: ${jobData.costs.agentFee.toFixed(2)} Locus
Platform Fee (1.5%): ${jobData.costs.platformFee.toFixed(2)} Locus
--------------
Total Cost: ${jobData.costs.total.toFixed(2)} Locus
(~ $${jobData.costs.totalUsd.toFixed(2)} USD)

Thank you for using AI Agent Marketplace!
    `.trim()
    ...
    a.href = url
    a.download = `receipt-${jobData.id}.txt`
  ...
  const handleViewLogs = () => {
    addToast('Execution logs feature coming soon!', 'info')
  }
                  ...
                  <div className="p-6 flex flex-col gap-4">
                    ...
                    <div className="border-t border-border-light dark:border-border-dark pt-4 mt-2 flex flex-wrap gap-4">
                      <motion.button 
                        ...
                        className="flex items-center justify-center rounded-lg h-9 px-4 bg-primary/10 text-primary text-sm font-bold hover:bg-primary/20 transition-colors"
                      >
                      ...
                      <motion.button 
                        ...
                        className="flex items-center justify-center rounded-lg h-9 px-4 bg-background-light dark:bg-card-dark border border-border-light dark:border-border-dark text-gray-500 dark:text-gray-400 text-sm font-bold hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
                      >
