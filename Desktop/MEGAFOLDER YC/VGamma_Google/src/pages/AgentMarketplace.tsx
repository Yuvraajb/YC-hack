...
export default function AgentMarketplace() {
  ...
  const handleDeploy = () => {
    addToast(`${selectedAgent?.name} deployed successfully!`, 'success')
              ...
              <div className="flex justify-center mt-10">
                <nav className="flex items-center gap-2">
                  <motion.button
                    ...
                    className="flex items-center justify-center size-9 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <motion.button
                      ...
                      className={`flex items-center justify-center size-9 rounded-lg font-bold transition-colors ${
                        page === currentPage
