...
export default function JobDashboard() {
  return (
    <div className="flex min-h-screen w-full">
      {/* Side Navigation Bar */}
      <aside className="w-64 flex-shrink-0 bg-card-light dark:bg-card-dark border-r border-border-light dark:border-border-dark hidden md:flex flex-col">
        <div className="flex h-full min-h-0 flex-col justify-between p-4">
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3 px-2">
              <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCku82bHDtYIR3CvBHZrWqa57RPtG5Wt7QFS09Q8NTTBKt6r5idXqYtMKkzGiRrbt9JMhdn9BXWVEq1ajNzuBGFRKmPs4Q0R6zYr4fSmPzzWEnak3a5qqWEWBoPZ63Q69LPOBJXNRBiXLH7QlW8OSuObrmDSK8j9yuWEha5AMP6rKAOlkZwYTfou2HMjf0HY9ODWJuDhIQimz2veLrQ9h06m0T_c6I58a8rlYj4vez0rK4TADXy7NzJXhhJelYUm6qsSU5zpVjBg10")' }}></div>
              <div className="flex flex-col">
                <h1 className="text-base font-medium leading-normal">Locus AI</h1>
                <p className="text-gray-500 dark:text-gray-400 text-sm font-normal leading-normal">Agent Marketplace</p>
              </div>
            </div>
            <nav className="flex flex-col gap-2 mt-4">
              <Link to="/submit" className="flex items-center gap-3 px-3 py-2 text-gray-500 dark:text-gray-400 hover:bg-primary/10 rounded-lg">
                <span className="material-symbols-outlined text-2xl">dashboard</span>
                <p className="text-sm font-medium leading-normal">Dashboard</p>
              </Link>
              <Link to="/marketplace" className="flex items-center gap-3 px-3 py-2 text-gray-500 dark:text-gray-400 hover:bg-primary/10 rounded-lg">
                <span className="material-symbols-outlined text-2xl">storefront</span>
                <p className="text-sm font-medium leading-normal">Marketplace</p>
              </Link>
              <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary">
                <span className="material-symbols-outlined text-2xl" style={{ fontVariationSettings: "'FILL' 1" }}>work</span>
                <p className="text-sm font-medium leading-normal">My Jobs</p>
              </Link>
            </nav>
          </div>
          <div className="flex flex-col gap-1">
            <a className="flex items-center gap-3 px-3 py-2 text-gray-500 dark:text-gray-400 hover:bg-primary/10 rounded-lg" href="#">
