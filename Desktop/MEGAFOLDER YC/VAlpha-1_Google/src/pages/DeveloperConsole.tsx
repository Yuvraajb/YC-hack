...
export default function DeveloperConsole() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Side Navigation Bar */}
      <aside className="w-64 flex-shrink-0 bg-white dark:bg-[#111418] p-4 flex flex-col justify-between border-r border-gray-200 dark:border-gray-800">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-3">
            <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBLQgiG8L63AhtZ3M8iVrBhHCoETw4e8NCIRHFsHob2fFtqpbGg_aI9m6Rro9a5Lzbe9obdSU2ar7wSdtid7zUaVXh8H63KX1G__Hkx1B7SBZ5S85BTt34-eopSpVqbg8QYFBki6wnltoVDxI3RHx98qHHqQhQ6aPOryeSyJ33NDuFe77zHIIBBSD4iWZ75FFhdYt8RhdqbrdLCdKIemo-Cqtu2hLl-evbr1IogvCz2MI7SjvvnOH08rU8ZYaJ_z3ozCVr7yUuJ7po")' }}></div>
            <div className="flex flex-col">
              <h1 className="text-base font-medium leading-normal">DevCorp</h1>
              <p className="text-gray-500 dark:text-[#9dabb9] text-sm font-normal leading-normal">developer@email.com</p>
            </div>
          </div>
          <nav className="flex flex-col gap-2 mt-4">
            <Link to="/submit" className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">dashboard</span>
              <p className="text-sm font-medium leading-normal">Dashboard</p>
            </Link>
            <Link to="/developer" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-custom-blue/10 dark:bg-custom-blue/20">
              <span className="material-symbols-outlined text-custom-blue font-bold">smart_toy</span>
              <p className="text-custom-blue text-sm font-bold leading-normal">My Agents</p>
            </Link>
            <Link to="/marketplace" className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">storefront</span>
              <p className="text-sm font-medium leading-normal">Marketplace</p>
            </Link>
            <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">bar_chart</span>
              <p className="text-sm font-medium leading-normal">Analytics</p>
            </Link>
            <a className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg" href="#">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">settings</span>
        ...
        <div className="flex flex-col gap-4">
          <Link to="/submit">
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-custom-blue text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-blue-600 transition-colors"
            >
              <span className="truncate">List a New Agent</span>
            </motion.button>
          </Link>
          <div className="flex flex-col gap-1">
            <a className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg" href="#">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">book</span>
              <p className="text-sm font-medium leading-normal">Documentation</p>
            </a>
            <a className="flex items-center gap-3 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg" href="#">
              <span className="material-symbols-outlined text-gray-500 dark:text-white">support_agent</span>
